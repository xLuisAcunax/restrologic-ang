      ...
      subItems: [
        {
          name: 'Opciones',
          path: '/admin/options',
          icon: `<svg xmlns=''http://www.w3.org/2000/svg'' width=''18'' height=''18'' viewBox=''0 0 48 48''><g fill=''none'' stroke=''currentColor'' stroke-linecap=''round'' stroke-linejoin=''round'' stroke-width=''3''><path d=''M24 6v8m0 20v8M6 24h8m20 0h8M11.27 11.27l5.66 5.66m14.14 14.14l5.66 5.66m0-25.46l-5.66 5.66M16.93 31.07l-5.66 5.66''/><path d=''M24 32a8 8 0 1 0 0-16a8 8 0 0 0 0 16''/></g></svg>`,
        },
        {
          name: 'Sucursales',
          path: '/admin/branches',
